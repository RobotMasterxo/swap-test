...
const BASIC_STAKE_ABI = process.env.REACT_APP_CHAIN_ID === '7668378' ? MainnetBasicStakeABI.abi : BasicStakeABI.abi
const CRYPTO_ROUTER_ABI = process.env.REACT_APP_CHAIN_ID === '7668378' ? MainnetCryptoRouter : CryptoRouter
